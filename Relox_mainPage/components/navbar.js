...
<div class = "container">
    <div class = "left-container">
        <img src="https://images.ctfassets.net/4cd45et68cgf/7LrExJ6PAj6MSIPkDyCO86/542b1dfabbf3959908f69be546879952/Relox-Brand-Logo.png?w=684&h=456"
        height = "100" alt="">
        <ul class = "nav-items">
    ...
    <div class="search">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/0/0b/Relox-avatar.png" height = "40" alt="">
    </div>
</div>
`