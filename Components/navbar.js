function navbar() {
    return `
       <div class="header-cont container">
               <div class="left-cont">
               <a href="/Relox_Home_Page_Static_Main/Relox_HomePage_Main.html"> <img class="brandlogo" id="brandlogo"
               src="Components/RELAX.png" alt=""> </a>
                   <ul class="main-nav ">
                       <a href="/Relox_Home_Page_Static_Main/Relox_HomePage_Main.html"><li class="nav-item active">HOME</li> </a>
                       <a href="/Pages/Relox_Home_Page.html"><li class="nav-item active">TRENDING</li> </a>
